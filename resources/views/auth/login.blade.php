          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <!-- image komputer analisis  -->
                <img src="https://inspirasisida.bontangkota.go.id/img/icon/dbpenelitian.png" alt="" class="img-fluid" style="align-items: center;/*! height: 400px; *//*! width: 900px; */padding-left: 90px;padding-top: 90px;">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Ecommerce</h1>
                  </div>
