				...
				<div class="single-widget recent-post">
					...
					<div class="single-post first">
						...
						<div class="content">
							...
							@endphp
							<p class="price"><del class="text-muted">Rp. {{number_format($product->price,2)}}

								</del> Rp. {{number_format($org,2)}} </p>
						</div>
					</div>
					<!-- End Single Post -->
					@endforeach
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-6 col-12">
							<div class="list-content">
								...
								<!-- <button class="btn cart" data-id="{{$product->id}}">Add to cart w</button> -->
