        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    @endif
                    <div class="content">
                        <h1 style="color: white;outline: #000000;">{{$cat->title}}</h1>
                        <a href="{{route('product-cat',$cat->slug)}}" style="color: white; font-size: 20px;">Discover Now</a>
                    </div>
                </div>
            </div>
            @endif
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    <i class="ti-rocket"></i>
                    <h4>Gratis Ongkir</h4>
                    <p>Pesanan Lebih Dari 10 Item</p>
                </div>
                <!-- End Single Service -->
            </div>
            <div class="col-lg-3 col-md-6 col-12">
