                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            @endphp
                            <li>
                                <img src="{{ asset('backend\img\dompet.png') }}" alt="">
                                @if (auth()->user())
                                <a href="">
                    ...
                    <div class="sinlge-bar shopping">
                        ...
                        <div class="shopping-item">
                            ...
                            <div class="bottom">
                                ...
                                <a href="{{route('test')}}" class="btn animate">Checkout</a>
                            </div>
                        </div>
                        @endauth
                        <!--/ End Shopping Item -->
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='topup' ? 'active' : ''}}"><a href="{{route('topup')}}">Topup</a></li>
